 ...
 */
var InstructorSessionsPageModule = /** @class */ (function () {
    function InstructorSessionsPageModule() {
    }
    InstructorSessionsPageModule = tslib_1.__decorate([
        NgModule({
            imports: [
                CommonModule,
    ...
    return InstructorSessionsPageModule;
}());
export { InstructorSessionsPageModule };
//# sourceMappingURL=instructor-sessions-page.module.js.map