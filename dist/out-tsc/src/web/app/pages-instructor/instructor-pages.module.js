...
import { InstructorHelpGettingStartedComponent, } from '../pages-help/instructor-help-page/instructor-help-getting-started/instructor-help-getting-started.component';
...
import { InstructorCourseDetailsPageComponent, } from './instructor-course-details-page/instructor-course-details-page.component';
import { InstructorCourseDetailsPageModule, } from './instructor-course-details-page/instructor-course-details-page.module';
...
import { InstructorCourseEnrollPageComponent, } from './instructor-course-enroll-page/instructor-course-enroll-page.component';
import { InstructorCourseEnrollPageModule, } from './instructor-course-enroll-page/instructor-course-enroll-page.module';
import { InstructorCourseStudentDetailsPageComponent, } from './instructor-course-student-details-page/instructor-course-student-details-page.component';
import { InstructorCourseStudentDetailsPageModule, } from './instructor-course-student-details-page/instructor-course-student-details-page.module';
import { InstructorCourseStudentEditPageComponent, } from './instructor-course-student-edit-page/instructor-course-student-edit-page.component';
import { InstructorCourseStudentEditPageModule, } from './instructor-course-student-edit-page/instructor-course-student-edit-page.module';
...
import { InstructorSessionEditPageComponent, } from './instructor-session-edit-page/instructor-session-edit-page.component';
import { InstructorSessionEditPageModule } from './instructor-session-edit-page/instructor-session-edit-page.module';
import { InstructorSessionResultPageComponent, } from './instructor-session-result-page/instructor-session-result-page.component';
import { InstructorSessionResultPageModule, } from './instructor-session-result-page/instructor-session-result-page.module';
...
import { InstructorStudentListPageComponent, } from './instructor-student-list-page/instructor-student-list-page.component';
import { InstructorStudentListPageModule, } from './instructor-student-list-page/instructor-student-list-page.module';
import { InstructorStudentRecordsPageComponent, } from './instructor-student-records-page/instructor-student-records-page.component';
import { InstructorStudentRecordsPageModule, } from './instructor-student-records-page/instructor-student-records-page.module';
var routes = [
    {
        path: 'home',
 ...
 */
var InstructorPagesModule = /** @class */ (function () {
    function InstructorPagesModule() {
    }
    InstructorPagesModule = tslib_1.__decorate([
        NgModule({
            imports: [
                CommonModule,
                PageNotFoundModule,
            ...
            providers: [
                {
                    ...
                    useValue: function (_component, _currentRoute, _currentState, nextState) {
                        return /^\/web\/instructor\/(home|courses|sessions|students|search|getting-started)$/.test(nextState.url);
                    },
                },
            ],
        })
    ], InstructorPagesModule);
    return InstructorPagesModule;
}());
export { InstructorPagesModule };
//# sourceMappingURL=instructor-pages.module.js.map