 ...
 */
var InstructorSessionResultPageModule = /** @class */ (function () {
    function InstructorSessionResultPageModule() {
    }
    InstructorSessionResultPageModule = tslib_1.__decorate([
        NgModule({
            declarations: [
    ...
    return InstructorSessionResultPageModule;
}());
export { InstructorSessionResultPageModule };
//# sourceMappingURL=instructor-session-result-page.module.js.map