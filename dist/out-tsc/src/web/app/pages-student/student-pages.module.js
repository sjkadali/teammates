 ...
 */
var StudentPagesModule = /** @class */ (function () {
    function StudentPagesModule() {
    }
    StudentPagesModule = tslib_1.__decorate([
        NgModule({
            imports: [
                CommonModule,
                PageNotFoundModule,
    ...
    return StudentPagesModule;
}());
export { StudentPagesModule };
//# sourceMappingURL=student-pages.module.js.map