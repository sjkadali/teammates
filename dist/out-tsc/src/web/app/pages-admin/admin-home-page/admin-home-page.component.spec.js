...
describe('AdminHomePageComponent', function () {
    var component;
    var fixture;
    var service;
    ...
    it('should add one instructor to list if all fields are filled', function () {
        ...
        fixture.detectChanges();
        var button = fixture.debugElement.nativeElement.querySelector('#add-instructor');
        button.click();
    ...
    it('should not add one instructor to list if some fields are empty', function () {
        component.instructorName = 'Instructor Name';
    ...
    it('should only add valid instructor details in the single line field', function () {
        ...
        fixture.detectChanges();
        var button = fixture.debugElement.nativeElement.querySelector('#add-instructor-single-line');
        button.click();
    ...
    it('should remove instructor out of queue if CANCEL is requested', function () {
        ...
        fixture.detectChanges();
        var button = fixture.debugElement.nativeElement.querySelector('#cancel-instructor-0');
        button.click();
        expect(component.instructorsConsolidated.length).toEqual(0);
    });
    it('should add instructor and update field when successful', function () {
        component.instructorsConsolidated = [
            {
                name: 'Instructor A',
                email: 'instructora@example.com',
        ...
        fixture.detectChanges();
        var button = fixture.debugElement.nativeElement.querySelector('#add-instructor-0');
        button.click();
    ...
    it('should not add instructor and update field when failure', function () {
        component.instructorsConsolidated = [
            {
                name: 'Instructor A',
                email: 'instructora@example.com',
    ...
    it('should add all instructors when prompted', function () {
        component.instructorsConsolidated = [
            {
                name: 'Instructor A',
                email: 'instructora@example.com',
        ...
        fixture.detectChanges();
        var button = fixture.debugElement.nativeElement.querySelector('#add-all-instructors');
        button.click();
    ...
    it('should snap with default view', function () {
        expect(fixture).toMatchSnapshot();
    });
    it('should snap with some instructors details', function () {
        component.instructorsConsolidated = [
            {
                name: 'Instructor A',
                email: 'instructora@example.com',
    ...
    it('should snap with disabled adding instructor button if there are active requests', function () {
        component.instructorsConsolidated = [
            {
                name: 'Instructor A',
                email: 'instructora@example.com',
...
//# sourceMappingURL=admin-home-page.component.spec.js.map