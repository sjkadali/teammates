 ...
 */
var AdminPagesModule = /** @class */ (function () {
    function AdminPagesModule() {
    }
    AdminPagesModule = tslib_1.__decorate([
        NgModule({
            imports: [
                CommonModule,
    ...
    return AdminPagesModule;
}());
export { AdminPagesModule };
//# sourceMappingURL=admin-pages.module.js.map