 ...
 */
var SessionsTableModule = /** @class */ (function () {
    function SessionsTableModule() {
    }
    SessionsTableModule = tslib_1.__decorate([
        NgModule({
            declarations: [
    ...
    return SessionsTableModule;
}());
export { SessionsTableModule };
//# sourceMappingURL=sessions-table.module.js.map