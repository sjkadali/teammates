 ...
 */
var QuestionSubmissionFormModule = /** @class */ (function () {
    function QuestionSubmissionFormModule() {
    }
    QuestionSubmissionFormModule = tslib_1.__decorate([
        NgModule({
            imports: [
                CommonModule,
    ...
    return QuestionSubmissionFormModule;
}());
export { QuestionSubmissionFormModule };
//# sourceMappingURL=question-submission-form.module.js.map