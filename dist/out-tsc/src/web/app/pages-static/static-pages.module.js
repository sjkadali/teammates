...
import { SessionLinksRecoveryPageComponent, } from '../pages-help/session-links-recovery/session-links-recovery-page.component';
import { SessionLinksRecoveryPageModule, } from '../pages-help/session-links-recovery/session-links-recovery-page.module';
...
var StaticPagesModule = /** @class */ (function () {
    ...
    StaticPagesModule = tslib_1.__decorate([
        NgModule({
            imports: [
                CommonModule,
                PageNotFoundModule,
